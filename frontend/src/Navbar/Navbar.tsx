...
const Navbar = () => {
  ...
  return <div>
    <div className="  flex justify-around sm:justify-between items-center pt-1 px-2 sm:px-5 md:px-10 bg-bodybg">
      <div className="">
        <img className=" h-9 aspect-square sm:h-16" src="./assets/logo.svg" alt="" />
      </div>
      {/* navlinks */}
      <div className="flex gap-4 text-sm font-medium sm:text-xl xmd:text-2xl sm:gap-10 sm:font-normal items-center">
          ...
          <Link to='/cart'>
            <div className="flex gap-1 items-center">
              ...
              <div className=" relative">
                ...
                <span className="absolute bg-red-500 rounded-full h-3 aspect-square text-[10px]  flex items-center justify-center -top-2 -right-1 sm:text-xl sm:h-6 sm:-top-4 sm:-right-2 ">2</span>
              </div>
            </div>
          </Link>
        </div>
        <div className="">
            <Link to=''>
              <img className="h-7 aspect-square sm:h-12" src="./assets/userr.svg" alt="" />
            </Link>
        </div>
      </div>
    </div>
