    ...
    <div className="">
      ...
      <div className="">
        {cartItems.map((item, index) => (
          <div
            key={index}
            className="w-full h-full grid grid-cols-4 sm:grid-cols-5 bg-bodybg rounded-lg   my-2"
          >
            ...
            <div className=" col-span-3 sm:col-span-4 flex flex-col gap-1 pl-5 p-1  sm:gap-3 sm:p-2">
              <div className="">
                <p className=" text-xs sm:text-xl xmd:text-2xl text-primaryBlue font-semibold">
                  {item.name}
                </p>
              </div>
              ...
              <div className="flex  items-center gap-4 ">
                ...
                <div
                  className={` h-4 w-4 sm:h-6 sm:w-6 rounded-full bg-${item.color} border-2 border-yellow-200`}
                ></div>
              </div>
              ...
              <div className=" grid grid-cols-3 gap-3 sm:grid-cols-4 sm:gap-8 items-center">
                ...
                <div className=" flex justify-around">
                  ...
                  <p className="text-xs sm:text-base xmd:text-xl flex items-center rounded-md border-2 px-3 bg-bgLightBlue">
                    {item.quantity}
                  </p>
                  <button className=" font-extrabold sm:text-2xl">+</button>
                </div>
                ...
                <div className="">
                  <button className=" bg-primaryBlue text-white  rounded-md text-xs sm:text-base xmd:text-xl py-1 sm:py-2 px-3 sm:px-5">
                    Buy now
                  </button>
                </div>
              </div>
