          ...
          <div className="bg-white  shadow-md px-2 xmd:px-10 py-2 xmd:py-10 rounded-xl">
            ...
            <div className=" my-2">
              <p className="text-xs sm:text-sm  xmd:text-base text-primaryBlue break-words">
                ...
                fashion. That's why we're proud to be involved in various
                philanthropic and environmental initiatives.One of our key
                partnerships is with a local charity organization that focuses
                on providing clothing and support to families in need. Through
                this partnership, we regularly donate clothing items and
