...
export default function AboutUsPage() {
  return (
    ...
    <div className={`pt-6 xmd:pt-20 px-2 sm:px-10 bg-bodybg h-full flex flex-col gap-4 sm:gap-6 xmd:gap-10 ${paddingForPage}`}>
      <div className=" mt-2">
        <div className="">
          <p className=" text-sm sm:text-2xl xmd:text-2xl  text-primaryBlue font-bold py-2 ">About us</p>
          <div className=" bg-black opacity-20 w-full h-[1px] sm:h-[2px] "></div>
        </div>
        <div className=" w-full py-4">
          <p className=" text-xs sm:text-sm  xmd:text-base text-primaryBlue break-words">Erlang Fashion Store is your premier destination for stylish clothing that combines quality, sustainability, and exceptional customer service. With a diverse selection of on-trend apparel, we cater to fashion-forward individuals who value both style and ethical practices. From chic everyday essentials to statement pieces, each garment is thoughtfully curated to elevate your wardrobe while minimizing environmental impact. Experience the perfect blend of fashion and conscience with Erlang Fashion Store.</p>
        </div>
      </div>
      ...
      <div className="">
          <div className="">
            <p className="  text-sm sm:text-2xl xmd:text-2xl  text-primaryBlue font-bold py-2 ">Testimonials</p>
            <div className=" bg-black opacity-20 w-full h-[1px] sm:h-[2px] "></div>
          </div>
