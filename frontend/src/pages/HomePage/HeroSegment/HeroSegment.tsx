      ...
      <div className=" flex flex-col sm:flex-row">
        ...
        <div className=" flex">
          <div className=" w-full h-45vh mx-10 relative">
            <img className=" h-full w-full xmd:w-35vw  xmd:h-70vh object-cover  object-top" src="../assets/image1.png" alt="" />
        ...
        <div className="">
          <div className="">
            <div className=" text-4xl xmd:text-6xl xl:text-7xl">
              ...
              <p className=" text-white xmd:text-primaryBlue xmd:font-semibold">DISCERNING </p>
              <p className=" text-white xmd:text-primaryBlue xmd:font-semibold">INDIVIDUAL</p>
            </div>
          </div>
