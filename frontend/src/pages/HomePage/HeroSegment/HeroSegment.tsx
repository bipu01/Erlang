  ...
  return (
    <div className={`  bg-bodybg  ${paddingForPage}`}>
      ...
      <div className=" grid sm:grid-cols-5  py-8 ">
        ...
        <div className=" col-span-3 grid grid-rows-2 sm:ml-5">
          <div className=" grid grid-flow-col  sm:grid-rows-2 order-last sm:order-none">
            ...
            <div className="">
              <p className="xmd:text-xl xl:text-2xl text-primaryBlue opacity-70">
      ...
      <div className=" flex gap-8 -mt-40 sm:mt-0">
        <div className="">
          <button className="bg-primaryBlue text-white py-4 px-12  rounded-md font-semibold text-sm sm:text-xl">
            Browse
          </button>
        </div>
        <div className="">
          <button className="bg-bodybg text-primaryBlue py-4 px-12  rounded-md font-semibold text-sm sm:text-xl">
            Watch Video
          </button>
        </div>
      </div>
