...
const getFeaturedProducts = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const featuredDressList = yield mongoClient.db(config_1.default.database).collection(req.body.category).find({ featured: true });
...
exports.default = getFeaturedProducts;
