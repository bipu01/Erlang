...
dressRouter.route("/getFeaturedDresses").get(getFeaturedDress_1.default);
dressRouter.route("/getAllDresses").get(getAllDress_1.default);
dressRouter.route("/postProduct").post();
